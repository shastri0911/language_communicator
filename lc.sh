...
python $var/src/user_csv_to_CLIPS_facts.py $var/$1 $var/tmp_dir/$file_name/hin-clips-facts.dat
...
python $var/src/MRS_facts_gen_frn_clips.py file.merge $file_name"_mrs"
